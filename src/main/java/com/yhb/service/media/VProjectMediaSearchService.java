 ...
 */
@Service
public class VProjectMediaSearchService extends BaseService {
    @Autowired
     ...
     * @return 根据多条件关键字进行查询
     */
    public List<VProjectMedia> findByConditions(String searchPhrase, int paramSize) {
        ...
        return vProjectMediaRepository.findByAuthKeyStartsWithAndProjectNameContainsAndFileNameContainsAndUserNameContainsAndUploadDateGreaterThanEqualAndUploadDateLessThanEqualAndStatusContains
