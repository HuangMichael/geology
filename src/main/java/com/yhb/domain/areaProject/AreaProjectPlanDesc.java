 ...
 */
@Entity
@Table(name = "T_AREA_PROJECT_PLAN_DESC")
@Data
public class AreaProjectPlanDesc extends DataFilter implements Serializable {
    @Id
    @SequenceGenerator(name = "AREA_PROJECT_PLAN_DESC_GENERATOR", sequenceName = "SEQ_AREA_PROJECT_PLAN_DESC", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "AREA_PROJECT_PLAN_DESC_GENERATOR")
