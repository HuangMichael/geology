 ...
 */
@Entity
@Table(name = "T_TOTAL_PLAN_DESC")
@Data
public class TotalPlanDesc extends DataFilter implements Serializable {
    @Id
    @SequenceGenerator(name = "TOTAL_PLAN_DESC_GENERATOR", sequenceName = "SEQ_TOTAL_PLAN_DESC", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "TOTAL_PLAN_DESC_GENERATOR")
