 ...
 */
@Entity
@Table(name = "T_TOTAL_PLAN")
@Data
public class TotalPlan extends DataFilter implements Serializable {
    @Id
    @SequenceGenerator(name = "TOTAL_PLAN_GENERATOR", sequenceName = "SEQ_TOTAL_PLAN", allocationSize = 1, initialValue = 6)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "TOTAL_PLAN_GENERATOR")
    ...
    private Double buildSize; //总规划面积
