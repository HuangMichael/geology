...
<div class="modal fade confirm_modal" id="confirm_modal">
    ...
    <form class="form-horizontal" id="areaForm">
        ...
        <div class="row-fluid">
                ...
                <div class="col-md-3">
                    <select class="form-control" id="city" name="cityId">
                        ...
                        <template v-for="c in citiesArray">
                            <option :value="c.id">{{c.text}}</option>o
                        </template>
                    </select>
                </div>
            </div>
            ...
            <div class="form-group ">
                <label for="reportSize" class="col-md-2 control-label">上报面积：</label>
                <div class="col-md-3">
...
<script type="text/javascript">
    ...
    var main = "thirteenFivePlan";
    var main2 = "thirteenFivePlanAll";
    var main3 = "sysMngThirteenFivePlan";
