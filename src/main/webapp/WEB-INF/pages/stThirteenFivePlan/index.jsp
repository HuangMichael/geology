...
<div id="layer" class="Absolute-Center" style="height: 149%;">
    <div class="div1" style="width: 932px;height: 510px;margin:421px  auto 0;padding: 0">
                        ...
                        <form class="form-inline pull-left">
                            <div class="form-group" id="searchBox" style="display: inline">
                                <%--<select class="form-control" id="planType">--%>
                                    <%--<option value="">--请选择规划类型--</option>--%>
                                    <%--<option value="总体规划">总体规划</option>--%>
                                    <%--<option value="十三五规划">十三五规划</option>--%>
                                <%--</select>--%>
...
<script type="text/javascript" src="/js/app/stThirteenFivePlan.js"></script>
</body>
</html>