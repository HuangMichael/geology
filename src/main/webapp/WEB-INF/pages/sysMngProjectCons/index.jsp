...
<div class="modal fade confirm_modal" id="confirm_modal">
    ...
    <form class="form-horizontal" id="projectConsForm">
        ...
        <div class="row-fluid">
            ...
            <div class="form-group ">
                <label for="consUnit" class="col-md-2 control-label">施工单位：</label>
                <div class="col-md-3">
                        ...
                        <div id="table">
                            <table id="dataTableList" class="table table-bordered table-hover" style="margin-top:10px">
                                ...
                                <tr>
                                    ...
                                    <th data-column-id="consUnit" data-width="8%" data-visible="false">建设单位</th>
                                    <th data-column-id="monitorUnit" data-width="8%" data-visible="false">监理单位</th>
...
<script src="/js/app/sysMngProjectCons.js"></script>
</body>
</html>