    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/areaMedia/uploadAndSave" class="dropzone" id="myDropzone" enctype="multipart/form-data" method="post">
                    <div class="fallback">
                        <input name="file" type="file" multiple=""/>
                    </div>
                </form>
                <button id="button_upload" action ="/areaMedia/uploadAndSave">上传</button>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row-fluid">
            ...
            <div class="span10">
                ...
                <form class="form-inline">
                    <div class="form-group" id="searchBox">
                        ...
                        <select type="text" class="form-control" id="areaName">
                            <option value="">--请选择区块名称--</option>
                            <template v-for="c in areasArray">
                ...
                <ul class="nav nav-tabs">
                    <li class="active" id="1"><a href="#projectDocuments">文档</a></li>
                    <li id="2"><a href="#projectPictures">图片</a></li>
                    <li id="3"><a href="#projectMedias">视频</a></li>
                    <div class="upload">
                ...
                <div class="floatingBox media-floatingBox">
                    <div class="containerHeadline tableHeadline">
                        <div class="container-fluid media-container-fluid">
                            <!-- ==================== FIRST TAB CONTENT ==================== -->
...
<script src="/js/app/areaMedia.js"></script>
</body>
