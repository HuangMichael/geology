    ...
    <form class="form-horizontal" id="areaForm">
        ...
        <div class="row-fluid">
            ...
            <div class="form-group ">
                ...
                <div class="col-md-3">
                    <input type="number"  class="form-control" id="reportSize" name="reportSize" placeholder="上报面积">
                </div>
            </div>
            ...
            <div class="form-group ">
                ...
                <div class="col-md-3">
                    <input type="number"  class="form-control" id="buildSize" name="buildSize" placeholder="规划面积">
                </div>
            </div>
            ...
            <div class="form-group ">
                ...
                <div class="col-md-3">
                    <input type="number"  class="form-control" id="nyBuildSize" name="nyBuildSize" placeholder="农业用地面积">
                </div>
            </div>
            ...
            <div class="form-group ">
                ...
                <div class="col-md-3">
                    <input type="number"  class="form-control" id="stBuildSize" name="stBuildSize" placeholder="生态用地面积">
                </div>
            </div>
            ...
            <div class="form-group ">
                ...
                <div class="col-md-3">
                    <input type="number"  class="form-control" id="jsBuildSize" name="jsBuildSize" placeholder="建设用地面积">
                </div>
            </div>
                        ...
                        <div id="table">
                            <table class="table  table-bordered table-hover bootgrid-table" id="dataTableList" style="margin-top:10px">
                                ...
                                <tr>
                                    ...
                                    <th data-column-id="areaName" data-width="10%">区块名称</th>
