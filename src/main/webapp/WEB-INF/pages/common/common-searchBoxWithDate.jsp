...
<input type="text" class="form-control" id="beginYear" onClick="WdatePicker({dateFmt:'yyyy-MM',isShowToday:false})" placeholder="开始年份" >
<input type="text" class="form-control" id="endYear" onClick="WdatePicker({dateFmt:'yyyy-MM',isShowToday:false})" placeholder="结束年份">
