        ...
        <div class="row-fluid">
            ...
            <div class="form-group ">
                ...
                <div class="pull-left">
                    ...
                    <div class="col-md-3">
                        <input type="text" class="form-control forVerify" id="projectSize" name="projectSize"
                               placeholder="项目占地面积">
                ...
                <div class="pull-left">
                    ...
                    <div class="col-md-3">
                        <textarea type="text" class="form-control" id="mainPurpose" name="mainPurpose"
                                  placeholder="主要用途" style="width: 57%;resize: none"></textarea></div>
                </div>
                <div class="pull-left">
