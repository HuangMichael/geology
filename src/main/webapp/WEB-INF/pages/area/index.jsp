        ...
        <div class="row-fluid">
            ...
            <div class="form-group ">
                <div class="pull-left">
                    ...
                    <div class="col-md-3">
                        <input type="number" class="form-control forVerify" id="buildSize" name="buildSize" min="0"
                               step="0.0001" placeholder="规划面积">
                ...
                <div class="pull-left">
                    ...
                    <div class="col-md-3">
                        <input type="number" class="form-control forVerify" id="inningSize" name="inningSize" min="0"
                               step="0.0001" placeholder="已围面积">
                        <div class="number_error"></div>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group ">
                ...
                <div class="pull-left">
                    <label for="avgHeight" class="col-md-2 control-label">平均起围高程：</label>
                    <div class="col-md-3">
            ...
            <div class="form-group ">
                <div class="pull-left">
                    ...
                    <div class="col-md-3">
                    <textarea type="texta" class="form-control" id="areaDesc" rows="5" name="areaDesc"
                        ...
                        <div id="table">
                            <table id="dataTableList" class="table  table-bordered table-hover" style="margin-top:10px">
                                ...
                                <tr>
                                    ...
                                    <th data-column-id="areaName" data-width="15%">区块名称</th>
