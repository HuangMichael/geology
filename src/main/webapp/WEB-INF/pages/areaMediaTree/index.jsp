    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <select type="text" class="form-control " id="selectArea" onchange="getSelectAreaId()">
                    <option value="">--请选择所属区块--</option>
                    <template v-for="a in areasArray">
            ...
            <div class="span10">
                ...
                <form class="form-inline">
                    <div class="form-group" id="searchBox">
                        <select type="text" class="form-control areaName" id="areaName">
                            <option value="">--请选择所属区块--</option>
...
<script src="/js/app/areaMediaTree.js"></script>
<%--<script>--%>
