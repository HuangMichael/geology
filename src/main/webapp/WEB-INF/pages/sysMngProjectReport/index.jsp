        ...
        <div class="row-fluid">
            ...
            <div class="form-group ">
                ...
                <div class="pull-left">
                    ...
                    <div class="col-md-3">
                        <input type="number" class="form-control" id="investedSum" name="investedSum" placeholder="投资额">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group ">
                <div class="pull-left">
                    ...
                    <div class="col-md-3">
                        <input type="number" class="form-control" id="investedProvince" name="investedProvince"
                               placeholder="省级补助资金">
                    </div>
                </div>
                <div class="pull-left">
                    ...
                    <div class="col-md-3">
                        <input type="number" class="form-control" id="investedCity" name="investedCity"
                               placeholder="市县补助资金">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group ">
                <div class="pull-left">
                    ...
                    <div class="col-md-3">
                        <input type="number" class="form-control" id="investedSelf" name="investedSelf"
                               placeholder="自筹资金">
                    </div>
                </div>
...
<script src="/js/app/sysMngProjectReport.js"></script>
</body>
</html>