    ...
    <form class="form-horizontal" id="areaForm">
        ...
        <div class="row-fluid">
            ...
            <div class="form-group ">
                ...
                <div class="col-md-3">
                    <input type="number" class="form-control buildSize" id="reportSize" name="reportSize" placeholder="上报面积">
            ...
            <div class="form-group ">
                ...
                <div class="col-md-3">
                    <input type="number" class="form-control buildSize" id="buildSize" name="buildSize" placeholder="总规划面积">
                    <div class="buildSize_error"></div>
                </div>
            </div>
            ...
            <div class="form-group ">
                ...
                <div class="col-md-3">
                    <input type="number" class="form-control buildSize" id="nyBuildSize" name="nyBuildSize" placeholder="农业用地面积">
                    <div class="buildSize_error"></div>
                </div>
            </div>
            ...
            <div class="form-group ">
                ...
                <div class="col-md-3">
                    <input type="number" class="form-control buildSize" id="stBuildSize" name="stBuildSize" placeholder="生态用地面积">
                    <div class="buildSize_error"></div>
                </div>
            </div>
            ...
            <div class="form-group ">
                ...
                <div class="col-md-3">
                    <input type="number" class="form-control buildSize" id="jsBuildSize" name="jsBuildSize" placeholder="建设用地面积" step="0.0001">
                    <div class="buildSize_error"></div>
                </div>
            </div>
            ...
            <div class="mySpan10">
                ...
                <div class="floatingBox table">
                    <div class="container-fluid">
                        ...
                        <div id="table">
                            <table class="table  table-bordered table-hover bootgrid-table" id="dataTableList" style="margin-top:10px">
                                <thead>
                                <tr>
                                    <th data-column-id="id" data-width="5%" data-type = "numeric" data-identifier="true">序号</th>
                                    <th data-column-id="areaNo" data-width="6%">区块编号</th>
                                    <th data-column-id="areaName" data-width="10%">所属区块</th>
                                    <th data-column-id="planDesc" data-width="8%">区块规划描述</th>
                                    <th data-column-id="beginYear" data-converter="datetime" data-width="6%">开始年份</th>
                                    <th data-column-id="endYear" data-converter="datetime" data-width="6%">结束年份</th>
...
<script type="text/javascript" src="/js/app/bqTotalPlan.js"></script>
<script>
