    ...
    <form class="form-horizontal" id="natureReserveExperimentForm">
        ...
        <div class="row-fluid">
            ...
            <div class="form-group " >
                ...
                <div class="col-md-3">
                    <input type="text" class="form-control" id="experimentName" name="experimentName" placeholder="试验区名称">
                </div>
            </div>
        ...
        <div class="row-fluid">
            ...
            <div class="mySpan10">
                ...
                <div class="containerHeadline tableHeadline">
                    ...
                    <h2>系统管理-地理信息管理-自然保护试验区信息</h2>
                </div>
                <div class="floatingBox table">
                    <div class="container-fluid">
                        <form class="form-inline pull-left">
                            <div class="form-group" id="searchBox">
                                <input type="text" class="form-control" id="lineNo" placeholder="试验区编号">
                                <input type="text" class="form-control" id="lineName" placeholder="试验区名称">
                        ...
                        <div id="table">
                            <table id="dataTableList" class="table  table-bordered table-hover" style="margin-top:10px">
                                ...
                                <tr>
                                    ...
                                    <th data-column-id="experimentNo" data-width="15%">试验区编号</th>
                                    <th data-column-id="experimentName" data-width="15%">试验区名称</th>
                                    <th data-column-id="experimentDesc" data-width="15%">试验区描述</th>
...
<script src="/js/app/natureReserveExperiment.js"></script>
</body>
