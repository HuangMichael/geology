...
docName = "系统管理-基础数据管理-围垦进度";
mainObject = "sysMngAreaBuilding";
deleteObject = "sysMngAreaBuilding";
appName = "围垦进度";
formId = "#areaForm";
 ...
 */
function authorize() {
    var areaBuildingIds = getCheckedValues();
    if (!areaBuildingIds) {
        showMessageBox("danger", "请选择要审核的围垦进度！");
        return;
    }
    var url = "sysMngAreaBuilding/authorizeInBatch";
    var requestData = {
        areaBuildingIds: areaBuildingIds
    };
