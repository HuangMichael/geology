...
function onClick(event, treeId, treeNode, clickFlag) {
    ...
    var dataRes = null;
    var url = "/areaMedia/findByTreeNodeCodeAndAuthKeyAndStatus";
...
$(function () {
    ...
    var url = "areaMediaTree/findMediaTree";
    createMedia(url);
    $.fn.zTree.init($("#treeDemo"), setting, zNodes);
    //初始化时查询所有文件，显示在页面中
    showAllFile(mediaComplexSearch("areaMedia"));
    ...
    Dropzone.options.myDropzone = {
        url: "/areaMedia/uploadFileAndSavePath",
        paramName: "file",
        maxFilesize: 10.0,// MB
        maxFiles: 10000,
        acceptedFiles: null,
        ...
        init: function () {
            ...
            this.on("success", function (file, data) {
                ...
                // log.info("url", encodeURI(downLoadUrl));
                // log.info("downLoadUrl", downLoadUrl);
                console.log("下载路径downLoadUrl-----------------", downLoadUrl);
...
function addNode(nodeName, pid) {
    ...
    $.post(url, obj, function (data) {
        console.log("addNode data", JSON.stringify(data));
    });
}
