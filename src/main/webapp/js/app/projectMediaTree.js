...
function onClick(event, treeId, treeNode, clickFlag) {
    ...
    console.log("treeNodeCode" + treeNodeCode);
    var dataRes = null;
    var url = "/projectMedia/findByTreeNodeCodeAndAuthKeyAndStatus";
...
var selectProjectId = null;


function getProjectId() {


    selectProjectId = $("#selectProject").val();
...
$(function () {
    ...
    var url = "projectMediaTree/findMediaTree";
    createMedia(url);
    ...
    initSelectData("#selectProject", {projectsArray: project});
    $("#selectProject").select2({'width': '30%'});


    Dropzone.options.myDropzone = {
        url: "/projectMedia/uploadFileAndSavePath",
        paramName: "file",
        maxFilesize: 10.0,// MB
        maxFiles: 10000,
        acceptedFiles: null,
        ...
        init: function () {
            ...
            this.on('sending', function (file, xhr, formData) {
                ...
                console.log("projectId", selectProjectId);
                formData.append("treeNodeId", treeNodeId);
                formData.append("projectId", selectProjectId);
            ...
            this.on("success", function (file, data) {
                ...
                var dl = '<dl>' +
                    '<dt class = "' + classUrl + '">' +
                    '<img name="sm_img" class="thumbnail" src=' + src + '>' +
                    '<div>' +
                    ...
                    '<a  id="lock" download="" title="加密"><i class="icon-lock"></i></a>' +
...
$("#lock").on("click", function () {
    var statusUrl = "/projectMedia/lockFile";
    var message = "确定要将这些文件设为审核通过么?";
    alert(message);
});


$("img[name='sm_img']").on("click", function () {
