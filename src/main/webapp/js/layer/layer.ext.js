...
layer.tab = function (parme) {
    var log = {}, parme = parme || {}, data = parme.data || [], conf = {
        ...
        page: {
            ...
            //切换事件
            var btn = $('.xubox_tabtit').children(), main = $('.xubox_tab_main').children(),
    ...
    if (json) {
        ...
        if (json.status === 1) {
            ...
            if (data.length > 0) {
                ...
                log.thissrc = data[json.start].id;
        ...
        log.thissrc = (nowimg.attr('layer-img') || nowimg.attr('id'));
    ...
    log.event = function () {
        ...
        log.tabimg = function () {
            ...
            if (json) {
                ...
                src = thisimg.attr('layer-img') || thisimg.attr('id');
