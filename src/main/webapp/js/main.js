(function (window) {
    ...
    !function () {
            ...
            !function (global, setTimeout) {
                ...
                function mixin(e, t, r, n) {
                    return t && eachProp(t, function (t, i) {
                        !r && hasProp(e, i) || (!n || "object" != typeof t || !t || isArray(t) || isFunction(t) || t instanceof RegExp ? e[i] = t : (e[i] || (e[i] = {}), mixin(e[i], t, r, n)))
                    }), e
                }
                ...
                function newContext(e) {
                    ...
                    function a(e, t, n, i) {
                        ...
                        return e || (l = !1, e = "_@r" + (T += 1)), c = o(e), p = c[0], e = c[1], p && (p = r(p, f, i), s = getOwn(A, p)), e && (p ? h = s && s.normalize ? s.normalize(e, function (e) {
                            return r(e, f, i)
                        }) : e.indexOf("!") === -1 ? r(e, f, i) : e : (h = r(e, f, i), c = o(h), p = c[0], h = c[1], n = !0, a = q.nameToUrl(h))), u = !p || s || n ? "" : "_unnormalized" + (R += 1), {
                            prefix: p,
                            name: h,
                            parentMap: t,
                            unnormalized: !!u,
                    ...
                    function l() {
                        var e, t, r = 1e3 * w.waitSeconds, o = r && q.startTime + r < (new Date).getTime(), a = [],
                            s = [], u = !1, p = !0;
                        if (!x) {
                    ...
                    var x, b, q, y, E,
                        w = {waitSeconds: 7, baseUrl: "./", paths: {}, bundles: {}, pkgs: {}, shim: {}, config: {}},
                        M = {}, S = {}, k = {}, O = [], A = {}, I = {}, j = {}, T = 1, R = 1;
                    return y = {
                        require: function (e) {
                        ...
                        init: function (e, t, r, n) {
                            n = n || {}, this.inited || (this.factory = t, r ? this.on("error", r) : this.events.error && (r = bind(this, function (e) {
                                    this.emit("error", e)
                                })), this.depMaps = e && e.slice(0), this.errback = r, this.inited = !0, this.ignore = n.ignore, n.enabled || this.enabled ? this.enable() : this.check())
                            ...
                            this.depMaps.push(n), u(n, "defined", bind(this, function (n) {
                                var i, o, p, d = getOwn(j, this.map.id), l = this.map.name,
                                ...
                                })), p = getOwn(M, o.id), void(p && (this.depMaps.push(o), this.events.error && p.on("error", bind(this, function (e) {
                                    this.emit("error", e)
                                })), p.enable()))) : d ? (this.map.url = q.nameToUrl(d), void this.load()) : (i = bind(this, function (e) {
                                    this.init([], function () {
                                        return e
                                    }, null, {enabled: !0})
                                }), i.error = bind(this, function (e) {
                                    this.inited = !0, this.error = e, e.requireModules = [t], eachProp(M, function (e) {
                        ...
                        configure: function (e) {
                            ...
                            eachProp(e, function (e, t) {
                                ...
                                isArray(e) && (e = {deps: e}), !e.exports && !e.init || e.exportsFn || (e.exportsFn = q.makeShimExports(e)), r[t] = e
                        ...
                        makeRequire: function (t, i) {
                            function o(r, n, u) {
                                var p, f, d;
                                return i.enableBuildCallback && n && isFunction(n) && (n.__requireJsBuild = !0), "string" == typeof r ? isFunction(n) ? c(makeError("requireargs", "Invalid require call"), u) : t && hasProp(y, r) ? y[r](M[t.id]) : req.get ? req.get(q, r, t, o) : (f = a(r, t, !1, !0), p = f.id, hasProp(A, p) ? A[p] : c(makeError("notloaded", 'Module name "' + p + '" has not been loaded yet for context: ' + e + (t ? "" : ". Use require([])")))) : (v(), q.nextTick(function () {
                                    v(), d = s(a(null, t)), d.skipMap = i.skipMap, d.init(r, n, u, {enabled: !0}), l()
                                }), o)
                            }
                            ...
                            return i = i || {}, mixin(o, {
                                isBrowser: isBrowser, toUrl: function (e) {
                                    ...
                                    return e = a(e, t, !1, !0).id, hasProp(A, e) || hasProp(M, e)
                                }
                            }), t || (o.undef = function (e) {
                                p();
                                var r = a(e, t, !0), i = getOwn(M, e);
                                i.undefed = !0, n(e), delete A[e], delete I[r.url], delete k[e], eachReverse(O, function (t, r) {
                                    t[0] === e && O.splice(r, 1)
                                }), delete q.defQueueMap[e], i && (i.events.defined && (k[e] = i.events), f(e))
                            }), o
                        },
                        enable: function (e) {
                            var t = getOwn(M, e.id);
                            ...
                            if (!i(t.id)) {
                                ...
                                return eachProp(M, function (e, n) {
                                    0 !== n.indexOf("_@r") && each(e.depMaps, function (e) {
                                        if (e.id === t.id)return r.push(n), !0
                                    })
                ...
                var req, s, head, baseElement, dataMain, src, interactiveScript, currentlyAddingScript, mainScript,
                    subPath, version = "2.3.2", commentRegExp = /\/\*[\s\S]*?\*\/|([^:"'=]|^)\/\/.*$/gm,
                    ...
                    defContextName = "_",
                    isOpera = "undefined" != typeof opera && "[object Opera]" === opera.toString(), contexts = {},
                ...
                if ("undefined" == typeof define) {
                    ...
                    "undefined" == typeof require || isFunction(require) || (cfg = require, require = void 0), req = requirejs = function (e, t, r, n) {
                        ...
                        if (isWebWorker)try {
                            setTimeout(function () {
                            }, 0), importScripts(r), e.completeLoad(t)
                        } catch (n) {
                        ...
                        "string" != typeof e && (r = t, t = e, e = null), isArray(t) || (r = t, t = null), !t && isFunction(r) && (t = [], r.length && (r.toString().replace(commentRegExp, commentReplace).replace(cjsRequireRegExp, function (e, r) {
                            t.push(r)
                        }), t = (1 === r.length ? ["require"] : ["require", "exports", "module"]).concat(t))), useInteractive && (n = currentlyAddingScript || getInteractiveScript(), n && (e || (e = n.getAttribute("data-requiremodule")), i = contexts[n.getAttribute("data-requirecontext")])), i ? (i.defQueue.push([e, t, r]), i.defQueueMap[e] = !0) : globalDefQueue.push([e, t, r])
        ...
        var o, a, s, u = function () {
            ...
            if (a && a.addImport || u(), a && a.addImport) s ? p.push([e, t]) : (f(e), s = t); else {
                ...
                var r = setInterval(function () {
                    try {
                        o.sheet.cssRules, clearInterval(r), t()
                    } catch (e) {
                    }
                }, 10)
            }
            ...
            if (i.type = "text/css", i.rel = "stylesheet", n) i.onload = function () {
                i.onload = function () {
                }, setTimeout(r, 7)
        ...
        }, a = /[^\:\/]*:\/\/([^\/])*/, s = /^(\/|data:)/, u = function (r, n, i, a) {
            n = o(n), i = o(i);
            for (var s, u, r,
                     c = /@import\s*("([^"]*)"|'([^']*)')|url\s*\((?!#)\s*(\s*"([^"]*)"|'([^']*)'|[^\)]*\s*)\s*\)/gi; s = c.exec(r);) {
        ...
        var n, i, o, a, s, u = ["Msxml2.XMLHTTP", "Microsoft.XMLHTTP", "Msxml2.XMLHTTP.4.0"],
            c = /^\s*<\?xml(\s)+version=[\'\"](\d)*.(\d)*[\'\"](\s)*\?>/im, p = /<body[^>]*>\s*([\s\S]+)\s*<\/body>/im,
            f = "undefined" != typeof location && location.href,
            d = f && location.protocol && location.protocol.replace(/\:/, ""), l = f && location.hostname,
            h = f && (location.port || void 0), m = {}, g = e.config && e.config() || {};
        return n = {
            version: "2.0.15", strip: function (e) {
            ...
            }, xdRegExp: /^((\w+)\:)?\/\/([^\/\\]+)/, useXhr: function (e, t, i, o) {
                ...
                r = t ? n.strip(r) : r, g.isBuild && (m[e] = r), i(r)
            }, load: function (e, t, r, i) {
                if (i && i.isBuild && !i.inlineText)return void r();
                g.isBuild = i && i.isBuild;
                var o = n.parseName(e), a = o.moduleName + (o.ext ? "." + o.ext : ""), s = t.toUrl(a),
                    u = g.useXhr || n.useXhr;
                return 0 === s.indexOf("empty:") ? void r() : void(!f || u(s, d, l, h) ? n.get(s, function (t) {
                ...
                var a = n.parseName(t), s = a.ext ? "." + a.ext : "", u = a.moduleName + s,
            ...
            t(u)
                ...
                try {
                    r = o["@mozilla.org/network/file-input-stream;1"].createInstance(a.nsIFileInputStream), r.init(i, 1, 0, !1), n = o["@mozilla.org/intl/converter-input-stream;1"].createInstance(a.nsIConverterInputStream), n.init(r, "utf-8", r.available(), a.nsIConverterInputStream.DEFAULT_REPLACEMENT_CHARACTER), n.readString(r.available(), u), n.close(), r.close(), t(u.value)
                } catch (e) {
    ...
    AMapUI.define("lib/utils", [], function () {
        ...
        var utils, defaultLogger = console, emptyfunc = function () {
        }, slientLogger = {
            log: emptyfunc,
            error: emptyfunc,
            warn: emptyfunc,
        ...
        utils = {
            ...
            map: function (array, callback, thisArg) {
                ...
                for (var newArr = [], i = 0,
                         len = array.length; i < len; i++) newArr[i] = callback.call(thisArg, array[i], i);
                return newArr;
            },
            ...
            subset: function (props) {
                ...
                utils.forEach(Array.prototype.slice.call(arguments, 1), function (source) {
                    if (source) for (var i = 0,
                                         len = props.length; i < len; i++) source.hasOwnProperty(props[i]) && (sobj[props[i]] = source[props[i]]);
                });
                return sobj;
            },
            ...
            random: function (length) {
                var str = "", chars = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXTZabcdefghiklmnopqrstuvwxyz",
                    clen = chars.length;
                length || (length = 6);
    ...
    AMapUI.define("lib/detect-global", ["./utils"], function (utils) {
        ...
        return {
            load: function (name, req, onLoad, config) {
                for (var parts = name.split("|"), gVars = parts[0].split(","), finalMod = parts[1], i = 0,
                         len = gVars.length; i < len; i++) {
        ...
        utils.extend(Event.prototype, {
            on: function (ev, listener, priority) {
                ...
                if (index < 0) {
                    ...
                    for (var inps = list.length, i = 0,
                             len = list.length; i < len; i++) if (priority > list[i].priority) {
                        inps = i;
                        break;
                    }
                    list.splice(inps, 0, {
    ...
    !function (ns, window) {
        ...
        ns.versionCompare = function (left, right) {
            ...
            for (var a = left.split("."), b = right.split("."), i = 0,
        ...
        ns.load = function (unames, callback, opts) {
            ns.require(["lib/utils"], function (utils) {
                ...
                for (var uname, mods = [], modNameFilter = opts && opts.modNameFilter, i = 0,
                         len = unames.length; i < len; i++) {
                    uname = unames[i];
