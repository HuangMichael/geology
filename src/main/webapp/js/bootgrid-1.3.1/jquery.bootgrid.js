...
;(function ($, window, undefined) {
                    ...
                    if (column.visible) {
                        ...
                        cells += tpl.cell.resolve(getParams.call(that, {
                            content: (value == null || value === "") ? "" +
                                "<button type=\"button\" class=\"btn btn-xs btn-default command-delete\" data-row-id=\"" + row.id + "\"><span class=\"fa fa-trash-o\">删除</span></button>" : value,
    ...
    Grid.defaults = {
        ...
        // rowCount: [10, 20, 50, 100], // rows per page int or array of int (-1 represents "All")
        rowCount: [10],
        /**
        ...
        labels: {
            all: "全部",
            infos: "显示第 {{ctx.start}} 条到第 {{ctx.end}} 条共 {{ctx.total}} 条",
            loading: "数据加载中...",
            noResults: "没有查询到记录!",
            // refresh: "刷新",
            search: "查询"
        ...
        templates: {
            ...
            actionButton: "<button class='btn btn-default' type='button' title='导出数据' onclick='exportExcel()'>导出</button>",
