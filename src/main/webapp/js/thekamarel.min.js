...
// (function (e, a) {
//     var c = e.createElement(a), b = e.getElementsByTagName(a)[0];
...
$(function () {
    ...
    setInterval(function () {
        var g = new Date(), i = g.getHours(), e = g.getMinutes(), h = g.getSeconds();
        e = (e < 10 ? "0" : "") + e;
        h = (h < 10 ? "0" : "") + h;
        i = (i == 0) ? 12 : i;
        var f = i + ":" + e + ":" + h;
    ...
    $(".mainmenu li, .mainmenu div.dropdown").click(function () {
        ...
        if ($(this).hasClass("dropdown")) {
            $(this).find(".dropdown-menu").css({minWidth: (e - 1) + "px"})
        }
    });
    ...
    $("ul.nav-tabs li a").click(function () {
        var e = $(this).attr("href"), f = $(this).closest("ul.nav-tabs").find("li.active");
    ...
    $(".sl1").slider();
    $(".sl2").slider({value: [40, 60], min: 0, max: 100, step: 1});
    ...
    $(".profilePhoto").hover(function () {
        $(this).animate({"background-position-x": "100%"}, "300")
    }, function () {
    ...
    $("ul.masterActions li").hover(function () {
        $(this).find("i").stop().animate({marginLeft: "25px"}, 300)
    }, function () {
        $(this).find("i").stop().animate({marginLeft: "0px"}, 300)
    });
